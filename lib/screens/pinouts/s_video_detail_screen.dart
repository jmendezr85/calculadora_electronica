...
const String _sVideoImagePath = 'assets/images/pinouts/s_video_connector.png';
const String _sVideoDescription =
    'S-Video (Separate Video) es un estándar de señal de video analógica que transporta datos de video como dos señales separadas de brillo (luminancia o "Y") y color (crominance o "C"). Al mantener estas dos señales separadas, S-Video reduce la interferencia en comparación con el video compuesto (que combina todo en una sola señal), ofreciendo una calidad de imagen superior para video de definición estándar. Se utiliza comúnmente en televisores, grabadoras de video, DVD/VCR combinados y algunos equipos informáticos antiguos.';
    ...
    'table_data': [
      {
        ...
        'pines': '4',
        'descripcion':
            'El conector S-Video más común. Transmite Luminancia (Y) y Crominancia (C) por separado.',
        'imagen_pinout': 'assets/images/pinouts/s_video_4_pin_pinout.png',
        'pin_details': [
          {'pin': '1', 'funcion': 'Ground (Y Return)', 'tipo_senal': 'Ground'},
          {'pin': '2', 'funcion': 'Ground (C Return)', 'tipo_senal': 'Ground'},
          {
            'pin': '3',
            'funcion': 'Y (Luminance / Brightness)',
            'tipo_senal': 'Luminance (Y)',
          },
          {
            'pin': '4',
            'funcion': 'C (Chrominance / Color)',
            'tipo_senal': 'Chrominance (C)',
          },
        ],
      },
      {
        ...
        'pines': '7',
        'descripcion':
            'Menos común, añade pines para video compuesto, datos, o tierra adicional. No todos los 7 pines se usan siempre.',
        'imagen_pinout': 'assets/images/pinouts/s_video_7_pin_pinout.png',
        'pin_details': [
          {'pin': '1', 'funcion': 'Ground (Y Return)', 'tipo_senal': 'Ground'},
          {'pin': '2', 'funcion': 'Ground (C Return)', 'tipo_senal': 'Ground'},
          {
          ...
          {
            'pin': '5',
            'funcion': 'Composite Video (Ground for C in 4-pin)',
            'tipo_senal': 'Composite (7-pin only)',
          },
          {
            'pin': '6',
            'funcion': 'Data / Aux Audio / NC',
            'tipo_senal': 'Data (7-pin only)',
          },
          {
            'pin': '7',
            'funcion': 'Composite Video Signal',
            'tipo_senal': 'Composite (7-pin only)',
          },
        ],
      },
    ...
    'list_data': [
      {
        ...
        'details':
            'S-Video está limitado a resoluciones de definición estándar, como 480i (NTSC) o 576i (PAL). No es apto para video de alta definición (HD).',
      },
      {
        'title': 'Sin Audio',
        'details':
            'S-Video transmite exclusivamente la señal de video. Para el audio, se requieren cables separados (como RCA estéreo o coaxial/óptico digital).',
      },
      {
        'title': 'Sin Protección de Copia (HDCP)',
        'details':
            'Al ser una interfaz analógica antigua, S-Video no soporta HDCP, lo que significa que no puede transportar contenido de alta definición protegido contra copia (ej. Blu-ray).',
      },
      {
        'title': 'Susceptible a Degradación',
        'details':
            'Aunque mejor que el video compuesto, la señal S-Video sigue siendo analógica y puede sufrir de ruido, degradación de la señal y "crosstalk" (interferencia entre Y y C) con cables largos o de mala calidad.',
      },
    ],
  },
  {
